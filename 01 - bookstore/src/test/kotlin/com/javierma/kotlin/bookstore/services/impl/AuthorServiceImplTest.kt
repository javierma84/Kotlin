...
import com.javierma.kotlin.bookstore.testAuthorEntityA
import com.javierma.kotlin.bookstore.testAuthorEntityB
import com.javierma.kotlin.bookstore.testAuthorUpdateRequestA
...
class AuthorServiceImplTest @Autowired constructor(
    ...
    @Test
    fun `test that save persist the Author in the database`() {
        val savedAuthor = underTest.create(testAuthorEntityA())
        assertThat(savedAuthor.id).isNotNull()

        // Kotlin obliga a gestionar el caso de que el id sea nulo, una forma de solucionarlo en plan rápido es con !!
